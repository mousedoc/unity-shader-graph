...
Shader "Universal Render Pipeline/NiloCat Extension/BillBoard LensFlare"
{
    Properties
    {
        ...
        [MainTexture] _MainTex("BaseMap (regular LDR texture)", 2D) = "white" {}
        ...
        [Toggle]_UsePreMultiplyAlpha("UsePreMultiplyAlpha (recommend _MainTex's alpha = 'From Gray Scale')", Float) = 0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(Varyings IN) : SV_Target
            {
                ...
                return saturate(SAMPLE_TEXTURE2D(_MainTex, sampler_MainTex, IN.uv)-_RemoveTextureArtifact) * IN.color;
            }
            ENDHLSL
        }
    }
